...
ActiveRecord::Schema.define(version: 20160124193251) do
  ...
  create_table "locations", force: :cascade do |t|
    ...
    t.string   "description"
    t.string   "image"
    t.string   "name",           default: "location"
    t.integer  "price",                               null: false
    t.integer  "developer_days"
    t.integer  "designer_days"
    t.datetime "created_at",                          null: false
  ...
  create_table "ugcontents", force: :cascade do |t|
    t.string   "title",                                null: false
    t.string   "description"
    t.string   "image"
    t.string   "name",           default: "ugcontent"
    t.integer  "price",                                null: false
    t.integer  "developer_days"
    t.integer  "designer_days"
    t.datetime "created_at",                           null: false
